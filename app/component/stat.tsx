...
function Stat() {
  return (
    <>
     {/* Stats Cards with Glassomorphism */}
        <div className="grid gap-4 md:grid-cols-3">
          <div className="glass-card rounded-2xl p-5 shadow-md hover:shadow-lg transition-shadow relative overflow-hidden">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-green-100/80 backdrop-blur-sm p-3 rounded-xl border border-white/30">
          ...
          <div className="glass-card rounded-2xl p-5 shadow-md hover:shadow-lg transition-shadow relative overflow-hidden">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-700">Active Accounts</p>
                <h3 className="text-2xl font-bold text-gray-900 mt-1">1,234</h3>
                <p className="text-xs text-blue-600 mt-1">+8% from last month</p>
              </div>
              <div className="bg-blue-100/80 backdrop-blur-sm p-3 rounded-xl border border-white/30">
          ...
          <div className="glass-card rounded-2xl p-5 shadow-md hover:shadow-lg transition-shadow relative overflow-hidden">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mt-1">567</h3>
                <p className="text-xs text-purple-600 mt-1">+23% from last month</p>
              </div>
              <div className="bg-purple-100/80 backdrop-blur-sm p-3 rounded-xl border border-white/30">
