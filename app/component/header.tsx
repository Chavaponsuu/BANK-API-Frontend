  ...
  return (
    <div className="glass-card rounded-2xl p-4 flex flex-col sm:flex-row justify-between items-center gap-4 shadow-md hover:shadow-lg transition-shadow">
      ...
      <div className="flex items-center gap-2">
        <button className="glass-card backdrop-blur-md border border-white/30 text-gray-800 text-sm font-medium px-4 py-2 rounded-xl hover:bg-white/50 transition-all shadow-sm">
          + Create Account
        </button>
        <button className="glass-card p-2 hover:bg-white/50 rounded-xl transition-all border border-white/30">
